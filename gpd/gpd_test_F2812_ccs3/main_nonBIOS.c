...
*
*	02/08/08 	1.0	 	original Release
*	05/22/08	1.1		Added driver for the MAX7301
*	07/22/08	1.2		Decreased the Kick-The-Dog period
*	09/16/08	1.3		Added driver to control sEEPROM on 100019640
*	10/02/08	1.4		Added diagnostics functions for 100019640 EEPROM
*	1/15/09		1.5		Modified test to work with rev.3 DTR. Also
*						modified the EEPROM data structure for DTR and PD.
**********************************************************************/
...
/*** Main Loop ***/
	while(1)							
	{
		...
		DelayUs(65535); /* Delay approximately 82mS */
		TxECanMsg(15, &TxMessage);
		GpioDataRegs.GPATOGGLE.bit.GPIOA0 = 1;
		GpioDataRegs.GPATOGGLE.bit.GPIOA1 = 1;
		GpioDataRegs.GPATOGGLE.bit.GPIOA2 = 1;
