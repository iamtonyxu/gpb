...
*/
	SysCtrlRegs.PLLCR.all = 0x0008;			// PLLx8; 120MHZ = SYSCLKOUT = CLKIN
...
/*** Configure CPU Timer0 as a 1mS Timer ***/
	CpuTimer0Regs.TCR.bit.TSS = 1;			// Stop Timer
	CpuTimer0Regs.PRD.all = 3000000;//11400000; //60000;			// Configure timer period for 1mS := 60,000/60,000,000
	CpuTimer0Regs.TPR.bit.TDDR = 0;			// TCLK = SYSCLKOUT/2 = 120,000,000/2 = 60,000,000
	CpuTimer0Regs.TCR.bit.FREE = 1;			// Free Running Timer
	CpuTimer0Regs.TCR.bit.TRB = 1;			// CPU Timer Reload
	CpuTimer0Regs.TCR.bit.TIE = 1;			// Enable Timer0 Interrupts
