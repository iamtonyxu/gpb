...
#define ADC_sample_period  60000            // 2999 = 50KHz sampling w/ 120MHz CPUCLK
...
// InitEv: 
//---------------------------------------------------------------------------
// This function initializes the Event Managers on the F281x.
//
void InitEv(void)
{
...
/************************************************************/
    ...
    EvaRegs.T2CON.all = 0xD140;         //enable timer
/*
