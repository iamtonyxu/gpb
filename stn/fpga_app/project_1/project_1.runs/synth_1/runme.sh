...
HD_PWD='C:/repo1/gpb/stn/fpga_app/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log can_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source can_top.tcl
