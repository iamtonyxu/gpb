...
read_vhdl -mode vhdl_2008 {C:\repo1\gpb\stn\fpga_hw\hdl\serial_eeprom_if_v2.vhd}
read_verilog -mode system_verilog {C:\repo1\gpb\stn\fpga_hw\hdl\EEPROM_OPB_IF_V2.v}
...
check_constraints {C:\repo1\gpb\stn\fpga_hw\constraint\synthesis_sdc_errors.log}
write_fdc {C:\repo1\gpb\stn\fpga_hw\designer\top_hw\synthesis.fdc}
